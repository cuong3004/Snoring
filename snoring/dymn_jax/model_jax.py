...
from dymn_jax.dy_block_jax import MyConv, DynamicInvertedResidualConfig, \
...
class DyMN(nn.Module):
    ...
    def setup(self):
        ...
        norm_layer = partial(nn.BatchNorm, not self.training, epsilon=0.001, momentum=1-0.01, axis=1)
